...
{
    public  class AddTitleAndPicModel : ViewModelBase
    {
        private int _id;
        ...
        public int? IsHandle
        {
            ...
            set { Set("IsHandle", ref _isHandle, value); }
        }
        ...
        private List<PictureControlModel> _picModelList;
        public List<PictureControlModel> PicModelList
        {
            get { return _picModelList; }
            set { Set("PicModelList", ref _picModelList, value); }
        }
